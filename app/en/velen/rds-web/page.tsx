...
export const metadata: Metadata = {
    title: 'How to Connect AWS RDS (Web) - Velen',
            ...
            <section className="relative py-24 px-6 overflow-hidden">
                ...
                <div className="relative z-10 max-w-4xl mx-auto text-center space-y-6 animate-in fade-in zoom-in duration-700">
                    ...
                    <h1 className="text-4xl md:text-6xl font-bold tracking-tight bg-gradient-to-r from-white via-slate-200 to-slate-400 text-transparent bg-clip-text">
                        AWS RDS Connection Guide (Web)
                    </h1>
                    <p className="text-xl md:text-2xl text-slate-400 leading-relaxed max-w-2xl mx-auto font-light">
                        Please find your database connection details in the AWS Management Console and enter them into Velen.
                    </p>
                </div>
            </section>
            ...
            <div className="max-w-4xl mx-auto px-6 space-y-24">
                ...
                <div className="group relative grid md:grid-cols-2 gap-12 items-center">
                    <div className="space-y-6 relative z-10">
                        ...
                        <h2 className="text-3xl font-bold">Access RDS Console</h2>
                        <div className="space-y-4 text-slate-400 text-lg leading-relaxed">
                            <p>
                                Log in to the <a href="https://console.aws.amazon.com/rds" target="_blank" rel="noreferrer" className="text-purple-400 hover:text-purple-300 underline underline-offset-4 transition-colors">AWS RDS Console</a>.
                            </p>
                            <p>
                                Select <strong className="text-white">Databases</strong> from the left menu and click the <strong>DB identifier</strong> of the database you want to connect to.
                            </p>
                        </div>
                    </div>
                ...
                <div className="group relative grid md:grid-cols-2 gap-12 items-center md:flex-row-reverse">
                    ...
                    <div className="space-y-6 md:order-2">
                        ...
                        <h2 className="text-3xl font-bold">Check Endpoint and Port</h2>
                        <div className="space-y-4 text-slate-400 text-lg leading-relaxed">
                            <p>Check the <strong className="text-white">Connectivity & security</strong> tab.</p>
                            <p>Copy the following information:</p>
                            <ul className="list-disc pl-5 space-y-2">
                                <li><strong className="text-white">Endpoint</strong>: e.g.) <code className="bg-slate-900 px-1 rounded text-sm text-slate-300">mydb.xxx.ap-northeast-2.rds.amazonaws.com</code></li>
                                <li><strong className="text-white">Port</strong>: e.g.) <code className="bg-slate-900 px-1 rounded text-sm text-slate-300">5432</code>, <code className="bg-slate-900 px-1 rounded text-sm text-slate-300">3306</code></li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div className="group relative grid md:grid-cols-2 gap-12 items-center">
                    <div className="space-y-6">
                        ...
                        <h2 className="text-3xl font-bold">Check Master Username</h2>
                        <div className="space-y-4 text-slate-400 text-lg leading-relaxed">
                            <p>Go to the <strong className="text-white">Configuration</strong> tab.</p>
                            <p>Check and copy the <strong className="text-white">Master username</strong>.</p>
                            <div className="bg-orange-500/10 border border-orange-500/30 p-4 rounded-lg text-sm text-orange-300 flex items-start gap-3">
                                ...
                                <div className="space-y-1">
                                    <p className="font-semibold">Lost your password?</p>
                                    <p>You can set a new password by clicking the <span className="text-white px-1 border border-slate-600 rounded bg-slate-800">Modify</span> button at the top right. (No server reboot required)</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div className="group relative grid md:grid-cols-2 gap-12 items-center md:flex-row-reverse">
                    ...
                    <div className="space-y-6 md:order-2">
                        ...
                        <h2 className="text-3xl font-bold">Enter Information</h2>
                        <div className="space-y-4 text-slate-400 text-lg leading-relaxed">
                            <p>Enter the confirmed information into Velen and test the connection.</p>
