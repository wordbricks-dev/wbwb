            ...
            <section className="relative py-24 px-6 overflow-hidden">
                ...
                <div className="relative z-10 max-w-4xl mx-auto text-center space-y-6 animate-in fade-in zoom-in duration-700">
                    ...
                    <h1 className="text-4xl md:text-6xl font-bold tracking-tight bg-gradient-to-r from-white via-slate-200 to-slate-400 text-transparent bg-clip-text">
                        Amplitude API Key Guide
                    </h1>
                    <p className="text-xl md:text-2xl text-slate-400 leading-relaxed max-w-2xl mx-auto font-light">
                        To analyze Amplitude data, you need an API Key and Secret Key. Please verify following the guide below.
                    </p>
                </div>
            </section>
            ...
            <div className="max-w-4xl mx-auto px-6 space-y-24">
                ...
                <div className="group relative grid md:grid-cols-2 gap-12 items-center">
                    <div className="space-y-6 relative z-10">
                        ...
                        <div className="space-y-4 text-slate-400 text-lg leading-relaxed">
                            <p>
                                Please login to <a href="https://analytics.amplitude.com/" target="_blank" rel="noreferrer" className="text-purple-400 hover:text-purple-300 underline underline-offset-4 transition-colors">Amplitude</a>.
                            </p>
                            <p>
                                Click <strong className="text-white">Settings</strong> (gear icon) at the bottom left, or go to the <strong className="text-white">Organization Settings</strong> menu at the top right.
                            </p>
                        </div>
                    </div>
                ...
                <div className="group relative grid md:grid-cols-2 gap-12 items-center md:flex-row-reverse">
                    ...
                    <div className="space-y-6 md:order-2">
                        ...
                        <h2 className="text-3xl font-bold">Select Project</h2>
                        <div className="space-y-4 text-slate-400 text-lg leading-relaxed">
                            <p>
                                Click <strong className="text-white">Projects</strong> in the left sidebar menu.
                            </p>
                            <p>
                                Click the name of the project you want to integrate data from to go to the details page.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div className="group relative grid md:grid-cols-2 gap-12 items-center">
                    <div className="space-y-6">
                        ...
                        <h2 className="text-3xl font-bold">Check API Key and Secret Key</h2>
                        <div className="space-y-4 text-slate-400 text-lg leading-relaxed">
                            <p>
                                Check the information at the top of the <strong className="text-white">General</strong> tab.
                            </p>
                            <ul className="list-disc pl-5 space-y-2">
                                <li><strong className="text-white">API Key</strong>: Can be copied immediately.</li>
                                <li><strong className="text-white">Secret Key</strong>: Click the <span className="bg-slate-800 text-white px-2 py-0.5 rounded text-sm">Show</span> button to view and copy the key.</li>
                            </ul>
                            <div className="bg-orange-500/10 border border-orange-500/30 p-4 rounded-lg text-sm text-orange-300 flex items-start gap-3">
                                ...
                                <span>The Secret Key can only be viewed once for security, so please save it in a safe place immediately.</span>
                            </div>
                        </div>
                    </div>
                    <div className="relative group-hover:-translate-y-2 transition-transform duration-500">
                ...
                <div className="group relative grid md:grid-cols-2 gap-12 items-center md:flex-row-reverse">
                    ...
                    <div className="space-y-6 md:order-2">
                        ...
                        <h2 className="text-3xl font-bold">Enter into Velen</h2>
                        <div className="space-y-4 text-slate-400 text-lg leading-relaxed">
                            <p>Please enter the copied key values into the Velen setup screen.</p>
                    ...
                    <div className="bg-gradient-to-br from-slate-900 to-slate-950 p-12 rounded-3xl border border-slate-800 max-w-3xl mx-auto relative overflow-hidden group">
                        ...
                        <div className="relative z-10 space-y-6">
                            ...
                            <p className="text-xl text-slate-400">
                                You can now analyze powerful user behavior data from Amplitude.
                            </p>
                        </div>
                    </div>
                </section>
