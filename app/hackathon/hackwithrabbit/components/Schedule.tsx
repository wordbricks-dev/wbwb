        ...
        <div className="max-w-3xl mx-auto">
          {scheduleData.map((day, idx) => (
            <div key={idx} className="space-y-6">
              <h3 className="text-xl font-bold text-primary border-b border-slate-800 pb-4 text-center">{day.day}</h3>
              <div className="space-y-8">
                {day.events.map((event, eventIdx) => (
                  <div key={eventIdx} className="relative pl-8 border-l-2 border-slate-800 hover:border-primary transition-colors group">
