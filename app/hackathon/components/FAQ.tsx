            ...
            return (
              <div 
                ...
                className={`bg-slate-900/50 border rounded-2xl transition-all duration-300 overflow-hidden ${
                  isOpen ? 'border-hackathon-primary/50 shadow-lg shadow-hackathon-primary/5 bg-slate-900' : 'border-slate-800 hover:border-slate-700'
                }`}
              >
                <button
                ...
                >
                  <div className="flex items-center gap-4">
                    <div className={`p-2 rounded-lg bg-slate-950 border border-slate-800 transition-colors ${isOpen ? 'border-hackathon-primary/30' : 'group-hover:border-slate-700'}`}>
                      {item.icon}
                    </div>
                  ...
                  <ChevronDown 
                    className={`w-5 h-5 text-slate-500 transition-transform duration-300 ${isOpen ? 'rotate-180 text-hackathon-primary' : ''}`} 
                  />
                </button>
